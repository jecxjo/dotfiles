...
-- arrays
vim.api.nvim_set_keymap('ia', 'foreach@', '.forEach((v) => { })', { noremap = true, silent = true })
vim.api.nvim_set_keymap('ia', 'map@', '.map((v) => { })', { noremap = true, silent = true })
vim.api.nvim_set_keymap('ia', 'filter@', '.filter((v) => { })', { noremap = true, silent = true })
vim.api.nvim_set_keymap('ia', 'find@', '.find((v) => { })', { noremap = true, silent = true })
